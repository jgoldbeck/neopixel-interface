...
class TwistedPuddle(object):
    def __init__(self, port):
        ...
        self.sparkle_fraction = 0.005
        self.sparkle_fraction_amplification = 4 # music responsive
        self.sparkle_length = 2
        self.sparkle_fade_rate = 0.005 # non-music responsive
        self.sparkle_fade_randomness_amplification = 100 # music responsive
        self.sparkle_fraction_music_correction = 0.09
        self.brightness_min = 15 # prevents the final color in the fade from being strongly colored when quiet
        self.amplification = 250.
        self.threshold_decay = .2


        ## colors
        self.off_white = bytearray([140, 185, 157]) # g, r, b
